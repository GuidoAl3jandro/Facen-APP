...
| INSCRIPCIONES | 5 | Asignaturas base inscriptas para demo/perfiles activos |
| NOTAS | 5 | Registro base de notas por inscripcion |
...
- Inscripciones base compatibles para el perfil activo: `MAT201` y `MAT120`.
